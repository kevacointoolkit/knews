...
echo "<!DOCTYPE html><html lang=\"en\"><head><meta charset=\"UTF-8\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1, shrink-to-fit=no\"><meta name=\"apple-mobile-web-app-capable\" content=\"yes\"><title>".hex2bin($gname)." SPACE</title><meta name=\"description\" content=\"Decentralized SPACE ".hex2bin($gname)."\"><link rel=\"stylesheet\" type=\"text/css\" href=\"css/bootstrap.min.css?version=3.12.0\"><link rel=\"stylesheet\" type=\"text/css\" href=\"css/style.css?version=3.12.0\"><style>::-webkit-scrollbar { width: 0 !important }html, body {margin: 0 auto -100px;padding: 0;}</style></head><body><div class=\"container mt-4\"><div class=\"row\"><div class=\"col-md-8\">";


echo "<div class=\"card mt-2\"><div class=\"card-body\"><div class=\"card-title\"><h3 class=\"text-primary\"><span  ".$rgb.">K NEWS<span></h3></div><p class=\"text-info card-subtitle mb-3\"></p><div><div id=\"post-content\"><div class=\"card-text\"></div></div></div></div></div>";
...
foreach ($totalass as $k=>$v) 
		...
		echo "<div class=\"card mt-2\"><div class=\"card-body\"><div class=\"card-title\"><a href=kpress.php?n=".$np."><h3 class=\"text-primary\">".$npn."</h3></a></div><p class=\"text-info card-subtitle mb-3\"><span>".$block."".$count."</span></p><div><div id=\"post-content\"><div class=\"card-text\">".$valuex."</div></div></div></div></div>";
